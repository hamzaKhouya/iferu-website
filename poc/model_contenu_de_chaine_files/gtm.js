...
r.value)};l(K,V,!1);F("send",V);}else if("TRACK_SOCIAL"==q.vtp_trackType){var U={hitType:"social",socialNetwork:String(q.vtp_socialNetwork),socialAction:String(q.vtp_socialAction),socialTarget:String(q.vtp_socialActionTarget)};l(K,U,!1);F("send",U);}else if("TRACK_TRANSACTION"==q.vtp_trackType){
...
h("_setCustomVar",function(J){for(var K=[],V=0;J&&V<J.length;V++){var U=J[V];void 0!==U.value&&(U.slot=Va(U.slot),U.scope=n(Va,U.scope),K.push(U))}return K}(c.vtp_customVar),["slot","name","value","scope"]);d("_set","hitCallback",function(){Ja(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){
d("_trackEvent",String(c.vtp_eventCategory),String(c.vtp_eventAction),n(String,c.vtp_eventLabel),n(Va,c.vtp_eventValue),!!c.vtp_nonInteraction);}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==c.vtp_trackType){}else if("TRACK_SOCIAL"==c.vtp_trackType){var Q=function(J,K){return c.vtp_socialUseDataLayer?Tp(J,1):c[K]};d("_trackSocial",String(Q("socialNetwork","vtp_socialNetwork")),String(Q("socialAction","vtp_socialAction")),n(String,Q("socialTarget","vtp_socialTarget")),n(String,c.vtp_socialPagePath));
