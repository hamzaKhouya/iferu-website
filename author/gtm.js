...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003EpiAId=\"903971\";piCId=\"6461\";piHostname=\"pi.pardot.com\";(function(){function b(){var a=document.createElement(\"script\");a.type=\"text\/javascript\";a.src=(\"https:\"==document.location.protocol?\"https:\/\/pi\":\"http:\/\/cdn\")+\".pardot.com\/pd.js\";var c=document.getElementsByTagName(\"script\")[0];c.parentNode.insertBefore(a,c)}window.attachEvent?window.attachEvent(\"onload\",b):window.addEventListener(\"load\",b,!1)})();\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":186
  ...
  "predicates":[{
      ...
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"https:\/\/www.iferu.com\/?trialSuccess=true"
    },{
      "function":"_re",
      "arg0":["macro",28],
      "arg1":"iferu\\.com\\\/..\\\/trial"
    },{
      "function":"_eq",
      "arg0":["macro",1],
      "arg1":"gtm.formSubmit"
  ...
  "rules":[
    ...
    [["if",27,28],["add",16]],
    [["if",29,30],["add",17]],
    [["if",1],["add",18,23,32,57,58,62,67,68,72,76,77,78,46,48,49,50,51,52]],
    [["if",1,31],["add",20,64]],
    [["if",17,32,33],["add",21]],
    [["if",17,34,35],["add",24]],
    [["if",17,36,37],["add",25]],
...
r.value)};l(K,W,!1);F("send",W);}else if("TRACK_SOCIAL"==q.vtp_trackType){var U={hitType:"social",socialNetwork:String(q.vtp_socialNetwork),socialAction:String(q.vtp_socialAction),socialTarget:String(q.vtp_socialActionTarget)};l(K,U,!1);F("send",U);}else if("TRACK_TRANSACTION"==q.vtp_trackType){
...
Z.b.ga=["google"],function(){var a,b;(function(c){Z.__ga=c;Z.__ga.g="ga";Z.__ga.h=!0;Z.__ga.priorityOverride=0})(function(c){function d(J){var K=[].slice.call(arguments,0);K[0]=u+K[0];t.push(K)}function e(J,K){void 0!==c[K]&&d(J,c[K])}function f(J,K){void 0!==c[K]&&d(J,Number(c[K]))}function g(J,K){if(q(K))for(var W=0;W<K.length;W++)d(J,K[W])}function h(J,K,W){if(q(K))for(var U=0;U<K.length;U++){for(var P=[J],xa=K[U],S=0;S<W.length;S++)P.push(xa[W[S]]);
d.apply(this,P)}}function l(J,K){void 0!==c[K]&&d("_set",J,c[K])}function p(J,K){return void 0===K?K:J(K)}function n(J,K){void 0!==K&&(v+="&"+J+"="+K)}var q=Na,t=T("_gaq",[],!1),r=!1,u="";void 0==c.vtp_trackerName?u="gtm"+Fh()+".":""!==c.vtp_trackerName&&(u=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",Tl(!0));
l("page","vtp_page");e("_setAllowLinker","vtp_allowLinker");
e("_setAllowAnchor","vtp_allowAnchor");e("_setAllowHash","vtp_allowHash");
g("_addIgnoredRef",c.vtp_ignoredRef);g("_addIgnoredOrganic",c.vtp_ignoredOrganic);var v="";if(""!==v){var w=function(J,K,W){for(var U=K.length-1;0<=U;U--){var P=K[U].split("=");if(P[0]===J)return P[1]||"1"}for(var xa=W.length-1;0<=xa;xa--){var S=W[xa].split("=");if(S[0]===J)return S[1]||"1"}},y=$g(eq()),x=Yg(y,"query").split("&"),z=c.vtp_allowAnchor?Yg(y,"fragment").split("&"):[];n("gclid",w("gclid",z,x));n("gclsrc",w("gclsrc",z,x));n("dclid",w("dclid",z,x));d("_set","campaignParams",
...
h("_setCustomVar",function(J){for(var K=[],W=0;J&&W<J.length;W++){var U=J[W];void 0!==U.value&&(U.slot=Wa(U.slot),U.scope=p(Wa,U.scope),K.push(U))}return K}(c.vtp_customVar),["slot","name","value","scope"]);d("_set","hitCallback",function(){La(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){
d("_trackEvent",String(c.vtp_eventCategory),String(c.vtp_eventAction),p(String,c.vtp_eventLabel),p(Wa,c.vtp_eventValue),!!c.vtp_nonInteraction);}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==c.vtp_trackType){}else if("TRACK_SOCIAL"==c.vtp_trackType){var Q=function(J,K){return c.vtp_socialUseDataLayer?hq(J,1):c[K]};d("_trackSocial",String(Q("socialNetwork","vtp_socialNetwork")),String(Q("socialAction","vtp_socialAction")),p(String,Q("socialTarget","vtp_socialTarget")),p(String,c.vtp_socialPagePath));
...
g("_cookiePathCopy",c.vtp_cookiePathCopy);var ea=function(){T("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,R(Jj("https","http","://stats.g.doubleclick.net/dc.js",r),ea,c.vtp_gtmOnFailure));else if(!a){var wa=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;R(Jj("https://ssl","http://www",wa,r),ea,c.vtp_gtmOnFailure)}})}();
