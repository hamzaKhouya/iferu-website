...
<script>(function(H){H.className=H.className.replace(/\bno-js\b/,'js'); if('ontouchstart' in document){H.className=H.className.replace('no-touch', '');}})(document.documentElement)</script>
	...
	</script><script src="./fr_reset-password_email_files/j.php" type="text/javascript"></script>
...
</style><script type="text/javascript" src="./fr_reset-password_email_files/analytics"></script></head>
<body class=""><div id="hs-feedback-fetcher"><iframe frameborder="0" src="./fr_reset-password_email_files/feedback-web-fetcher.html"></iframe></div>

		<script>
			dataLayer = [{
				"PageView": "\x2Ffr\x2Freset\x2Dpassword\x2Femail"
				
			}];
		</script>
		
	<div class="sr-only"><a href="https://www.iferu.com/fr/reset-password/email#main-content" tabindex="-1">Ignorer la navigation</a></div>
	<?php 
 include ("./header.php")
...
<!--- START MAIN_BODY -->
	<div class="primary container">
		...
		<h1>iferu – Assistant mot de passe</h1>

		<p>Merci de préciser votre adresse électronique</p>

		
		<form id="resetpasswordemail" action="forgotemail.php" method="post">
...
<fieldset class="form-fieldset form-horizontal">
				...
				<div class="form-group">
					<label for="usernameField" class="control-label col-sm-4">Mon adresse électronique est :</label>
					<div class="col-sm-6">
...
<div class="form-group">
		...
		<div class="col-sm-6 col-sm-offset-4">
			...
			<button type="submit" id="reset-submit" class="btn btn-warning">
				Continuer
			</button>
    	...
    	<p>
    		Si vous ne pouvez pas fournir l'adresse électronique requise ci-dessous, cliquez <a href="https://www.iferu.com/Support.do">ici</a>.
    	</p>
	...
	<div class="container">
		...
		<div class="footer__menu">
			<a href="https://www.iferu.com/" class="footer__logo footer__anchor">
				<img src="./fr_reset-password_email_files/ga-logo-round.svg" alt="iferu footer icon" height="102" width="102">
			</a>

			<div class="footer__menu-col panel">
				<a role="button" data-toggle="collapse" href="https://www.iferu.com/fr/reset-password/email#footer__menu-list-1" aria-expanded="false" aria-controls="footer__menu-list-1">
			...
			<div class="footer__menu-col panel">
				<a role="button" data-toggle="collapse" href="https://www.iferu.com/fr/reset-password/email#footer__menu-list-2" aria-expanded="false" aria-controls="footer__menu-list-2">
			...
			<div class="footer__menu-col panel">
				<a role="button" data-toggle="collapse" href="https://www.iferu.com/fr/reset-password/email#footer__menu-list-3" aria-expanded="false" aria-controls="footer__menu-list-3">
			...
			<div class="footer__menu-col panel">
				<a role="button" data-toggle="collapse" href="https://www.iferu.com/fr/reset-password/email#footer__menu-list-4" aria-expanded="false" aria-controls="footer__menu-list-4">
...
<script src="./fr_reset-password_email_files/jquery-3.5.1.min-cb-ngqyxctuyyypyq778izlo0vuklgdyde.js"></script>
<script src="./fr_reset-password_email_files/jquery-migrate-3.3.0.min-cb-s0j5pkzmbvf6ke354jyrczap4jdggih.js"></script>
<script src="./fr_reset-password_email_files/jquery-ui-1.12.1.min-cb-e1tewvf2mf31edp1mwyb8chlknvua6y.js"></script>
<script src="./fr_reset-password_email_files/slick.min-cb-rbyoskvgkr6j29jq6d01oiswyzxvm5z.js"></script>
<script src="./fr_reset-password_email_files/bootstrap-cb-qsbius9cxqxqgyzo703r3s033z2p9qx.js"></script>

<script src="./fr_reset-password_email_files/plugins-cb-263spjwuo2ql4ws8p9pvlrp95thejfn.js"></script>
<script src="./fr_reset-password_email_files/main-cb-jelr67bnj55qdbl7da6fg4blydtxduv.js"></script>
...
<script>
 	...
 	$(function(){
 		$.gaNotificationInit("/fr/notification/check?jsp=%2fWEB-INF%2fviews%2fcustomer%2freset-password-email.jsp", "/fr/notification/dismiss/{notificationId}");
 	});
</script>
	...
	<script type="text/javascript" src="./fr_reset-password_email_files/f(2).txt"></script>
	<noscript>
