...
<div class="primary col-sm-8">
			...
			<div class="subsection"><h2 class="first">Avec vos identifiants de connexion iferu</h2><form id="login" class="form-horizontal" action="#" method="POST">
				<div id="faildiv">
			<p id="passfail" class="alert-danger">Login not valid. Please check your email and password.</p>
			</div>
			<style>#logout{display:none;}
			
			#passfail{display:none;}</style>
...
<input id="onSuccess" name="onSuccess" type="hidden" value=""><input type="hidden" name="_tk" id="_tk" value="pSwHX8fVljHE7OA7JfPuI8pGChZktUvKB0GiO4HrXKQ">
					<div class="form-group">
						<label for="usernameField" class="col-sm-2 control-label">Username</label>
						<div class="col-sm-5">
							<input id="username" name="username" class="form-control" type="text" size="30" autocomplete="off">
						</div>
					</div>			
					<div class="form-group">
						<label for="passwordField" class="col-sm-2 control-label">Mot de passe</label>
						<div class="col-sm-5">
							<input id="password" name="password" class="form-control" type="password"  size="30" autocomplete="off">
						</div>
...
<div class="form-group">
		...
		<div class="col-sm-5 col-sm-offset-2">
			...
			<button type="button" id="connexionbtn" class="btn btn-warning">
				Connexion
			</button>
				...
				<p>
					Pas encore membre de iferu ? <a href="./fr-subscribe-account.php">Cliquez ici</a> pour vous inscrire dès maintenant !
				</p>
			</div>
</div><!-- End .primary -->
...
<script>
  function test(){
        window.location.href="./fr-login.php";}
